import { tasks, setTasks, getTasks } from './storage.js';
...
const createElements = (arr) => {
    return arr.map(({ text, done, id }) => {
        const listItemElem = document.createElement('li');
        listItemElem.setAttribute('id', id);
        let newClass = done ? "list__item-done" : "null";
...
export const renderListItem = () => {
    ...
    listElem.append(...createElements(sortElements(tasks, false)), ...createElements(sortElements(tasks, true)));
}
